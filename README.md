...
En la ruta generica para filtrado, se deben reemplazar los valores de "filtrar" por el nombre del atributo por el que se quieran filtrar los cruceros (ID, nombre, compania, capacidad y origen). Y el valor "valor" por el valor que debe tomar el mismo para ser mostrado en el filtro
##### Parámetros de filtrado
###### Filtro por nombre: 
    `cruceros?filtrar=nombre&valor=Nombre_requerido`
###### Filtro por compañia: 
    `cruceros?filtrar=compania&valor=Compañia_requerida`
###### Filtro por capacidad: 
    `cruceros?filtrar=capacidad&valor=capacidad_requerida`
El valor de la capacidad debe ser numérico y mayor que 0
###### Filtro por origen: 
    `cruceros?filtrar=origen&valor=origen_requerido`
-------------------
...
###### Ordenar por nombre: 
    `cruceros?criterio=nombre&orden=orden_requerido`
###### Ordenar por compañía: 
    `cruceros?criterio=compania&orden=orden_requerido`
###### Ordenar por capacidad: 
    `cruceros?criterio=capacidad`
Al no especificar, se ordenan de manera ascendente

###### Ordenar por origen: 
    `cruceros?criterio=origen&orden=orden_requerido`
-----------
...
En la ruta generica para filtrado, se deben reemplazar los valores de "filtrar" por el atributo por el que se quieran filtrar los tours (ID, id_crucero, destino, fecha_salida, precio). Y el valor "valor" por el valor que debe tomar el atributo para ser mostrado en el filtro
##### Parámetros de filtrado
###### Filtro por id: 
    `tours?filtrar=ID&valor=ID_requerido`

###### Filtro por crucero: 
    `tours?filtrar=id_crucero&valor=id_del_crucero_requerido`

###### Filtro por destino: 
    `tours?filtrar=destino&valor=destino_requerido`
    
###### Filtro por fecha de salida: 
    `tours?filtrar=fecha_salida&valor=fecha_requerida`

###### Filtro por precio: 
    `tours?filtrar=precio&valor=precio_requerido`
...
###### Ejemplo 1: 
    `tours?pagina=1&filas=fila_requerida`
###### Ejemplo 2: 
    `tours?pagina=2&filas=fila_requerida`
###### Ejemplo 3: 
    `tours?pagina=pagina_requerida&filas=3`
...
###### Filtro de crucero por capacidad: 
...
##### Parámetros de paginación de cruceros
###### Ejemplo 1: 
...
###### Ordenar tours por ID: 
    `tours?criterio=ID&orden=asc`
###### Devuelve:
Este endpoint devuelve todos los tours ordenados por su id de manera ascendente.

###### Ordenar tours por destino: 
    `tours?criterio=destino&orden=asc`
###### Devuelve:
Este endpoint devuelve todos los tours ordenados alfabeticamente por el destino al que se dirigen de manera ascendente:

###### Ordenar tours por fecha de salida: 
    `tours?criterio=fecha_salida`
###### Devuelve:
Este endpoint devuelve todos los tours ordenados por lafecha de salida de manera ascendente:

###### Ordenar tours por precio: 
    `tours?criterio=precio&orden=desc`
###### Devuelve:
Este endpoint devuelve todos los tours ordenados por el precio de manera descendente:
